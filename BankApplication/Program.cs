...
namespace BankApplication
{
    ...
    class Program
    {
        ...
        {
            Console.WriteLine("Укажите сумму для вывода");
        ...
        {
            Console.WriteLine("Ввведите сумму, чтобы положить на счет:");
            decimal sum = Convert.ToDecimal(Console.ReadLine());
        ...
        {
            Console.WriteLine("Введите id счета, который необходимо удалить:");
            int id = Convert.ToInt32(Console.ReadLine());
        ...
        private static void OpenAccount(Bank<Account> bank)
        {
            ...
            decimal sum = Convert.ToDecimal(Console.ReadLine());
            Console.WriteLine("Выберете тип счета: 1.До востребования 2. Депозитный");
